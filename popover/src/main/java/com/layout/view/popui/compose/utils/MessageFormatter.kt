/**
 * https://github.com/android/compose-samples/blob/686b5507628ff10a4676c455a2e32cf559b5e314/Jetchat/app/src/main/java/com/example/compose/jetchat/conversation/MessageFormatter.kt
 * 1f10771 on Oct 25, 2021, modified to add #hashtag parsing
 */
...
val symbolPattern by lazy {
    Regex("""(https?://[^\s\t\n]+)|(www?.[^\s\t\n]+)|(`[^`]+`)|(#[A-Za-z0-9_-]+)|(@[A-Za-z0-9_-]+)|(\*[\w]+\*)|(_[\w]+_)|(~[\w]+~)""")
