package app.skylab.compose.colors.tokens
...
internal object DefaultColorTokens {
     ...
     * Border Light colors
     */
    val activeBorderLight: ComposeColor = ComposeColor(0XFFADACAB)
     ...
     * Icon Light colors
     */
    val iconDefaultLight: ComposeColor = ComposeColor(0xFF5B5A57)
     ...
     */
    val contentNormal: ComposeColor = ComposeColor(0XFFFFFFFF)
    val contentMinor: ComposeColor = ComposeColor(0xFFEAEAEA)
